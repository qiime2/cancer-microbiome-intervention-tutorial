...
artifact
	...
	[qiime2R](https://github.com/jbisanz/qiime2R) for use with R, or
...
decentralized data provenance
	...
	which can be visualized with [QIIME 2 View](https://view.qiime2.org).
...
input
	...
	[filter-features](https://docs.qiime2.org/2020.8/plugins/available/feature-table/filter-features)
	{term}`action` in the
	[q2-feature-table](https://docs.qiime2.org/2020.8/plugins/available/feature-table/)
	{term}`plugin`.
...
method
	...
	example, the
	[filter-features](https://docs.qiime2.org/2020.8/plugins/available/feature-table/filter-features)
	{term}`action` in the [q2-feature-table](https://docs.qiime2.org/2020.8/plugins/available/feature-table/)
...
pipeline
	...
	[core-metrics](https://docs.qiime2.org/2020.8/plugins/available/diversity/core-metrics)
	{term}`action` in the
	[q2-diversity](https://docs.qiime2.org/2020.8/plugins/available/diversity/)
...
plugin
	...
	additional plugins is the [QIIME 2 Library](https://library.qiime2.org).
...
semantic type
	...
	[beta-phylogenetic](https://docs.qiime2.org/2020.8/plugins/available/diversity/beta-phylogenetic)
	{term}`method` in the
	[q2-diversity](https://docs.qiime2.org/2020.8/plugins/available/diversity/) {term}`plugin`,
...
visualization
	...
	viewed with [QIIME 2 View](https://view.qiime2.org>) on systems that
